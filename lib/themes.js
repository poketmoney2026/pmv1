export const THEME_LS_KEY = "pm_theme_bw_v7";
export const DEFAULT_THEME_ID = "black";

export const THEMES = [
  { id: "black", label: "BLACK", a: "#000000", b: "#0a0a0a", fg: "#f5f5f5" },
...
export function getThemeById(id) {
  ...
  return THEMES.find((item) => item.id === key) || THEMES.find((item) => item.id === DEFAULT_THEME_ID) || THEMES[0];
}
